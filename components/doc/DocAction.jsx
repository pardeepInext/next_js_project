        ...
        <div className="app-card-actions">
            <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                    <li>
                        <Link href={`document/${props.id}`}>
                            <a className="dropdown-item">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-eye me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a className="dropdown-item" href={props.file} download>
                    ...
                    <li>
                        <a className="dropdown-item" href="#">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-trash me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
